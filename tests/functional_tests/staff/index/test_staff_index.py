...
class StaffIndexFunctionalTest(BaseFunctionalTest):
    def test_staff_index_without_products_not_found_message(self):
        self.login_user(
    ...
    def test_staff_index_page_pagination(self):
